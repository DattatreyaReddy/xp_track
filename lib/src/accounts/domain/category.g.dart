...
const CategorySchema = CollectionSchema(
  ...
  idName: r'id',
  indexes: {
    r'includeInBalance': IndexSchema(
      id: 1129849077398131615,
      name: r'includeInBalance',
      unique: false,
      replace: false,
      properties: [
...
Category _categoryDeserialize(
  ...
  final object = Category(
    ...
    includeInBalance: reader.readBool(offsets[3]),
...
extension CategoryQueryWhereSort on QueryBuilder<Category, Category, QWhere> {
  ...
  QueryBuilder<Category, Category, QAfterWhere> anyIncludeInBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        const IndexWhereClause.any(indexName: r'includeInBalance'),
      );
    });
  }
...
extension CategoryQueryWhere on QueryBuilder<Category, Category, QWhereClause> {
  ...
  QueryBuilder<Category, Category, QAfterWhereClause> includeInBalanceEqualTo(
      bool includeInBalance) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'includeInBalance',
  ...
  QueryBuilder<Category, Category, QAfterWhereClause>
      includeInBalanceNotEqualTo(bool includeInBalance) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
              indexName: r'includeInBalance',
              lower: [],
              upper: [includeInBalance],
              includeUpper: false,
            ))
            .addWhereClause(IndexWhereClause.between(
              indexName: r'includeInBalance',
              lower: [includeInBalance],
              includeLower: false,
              upper: [],
            ));
      } else {
...
extension CategoryQueryFilter
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> lastModifiedIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
...
extension CategoryQuerySortBy on QueryBuilder<Category, Category, QSortBy> {
  ...
  QueryBuilder<Category, Category, QAfterSortBy> sortByIncludeInBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'includeInBalance', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> sortByIncludeInBalanceDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryQuerySortThenBy
  ...
  QueryBuilder<Category, Category, QAfterSortBy> thenByIncludeInBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'includeInBalance', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> thenByIncludeInBalanceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'includeInBalance', Sort.desc);
    });
  }
...
extension CategoryQueryWhereDistinct
  ...
  QueryBuilder<Category, Category, QDistinct> distinctByIncludeInBalance() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QDistinct> distinctByLastModified() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryQueryProperty
  ...
  QueryBuilder<Category, DateTime?, QQueryOperations> dateCreatedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, bool, QQueryOperations> includeInBalanceProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, DateTime?, QQueryOperations> lastModifiedProperty() {
    return QueryBuilder.apply(this, (query) {
